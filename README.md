...
This application is built with Flask Python Framework for the Backend. There
...
You can run your React app on [`localhost:4000`](http://localhost:3000) by running:
